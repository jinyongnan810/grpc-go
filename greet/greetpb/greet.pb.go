...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xdd, 0x01, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74,
	...
	0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x53, 0x0a,
	0x10, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x64, 0x4d, 0x61, 0x6e, 0x79, 0x54, 0x69, 0x6d, 0x65,
	...
	0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x3b, 0x67, 0x72, 0x65, 0x65,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	3, // 4: greet.GreetService.GreetedManyTimes:input_type -> greet.GreetManyTimesRequest
	...
	4, // 7: greet.GreetService.GreetedManyTimes:output_type -> greet.GreetManyTimesResponse
...
type GreetServiceClient interface {
	...
	GreetedManyTimes(ctx context.Context, in *GreetManyTimesRequest, opts ...grpc.CallOption) (GreetService_GreetedManyTimesClient, error)
...
func (c *greetServiceClient) GreetedManyTimes(ctx context.Context, in *GreetManyTimesRequest, opts ...grpc.CallOption) (GreetService_GreetedManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[0], "/greet.GreetService/GreetedManyTimes", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceGreetedManyTimesClient{stream}
...
type GreetService_GreetedManyTimesClient interface {
	Recv() (*GreetManyTimesResponse, error)
	grpc.ClientStream
}

type greetServiceGreetedManyTimesClient struct {
	grpc.ClientStream
}

func (x *greetServiceGreetedManyTimesClient) Recv() (*GreetManyTimesResponse, error) {
...
type GreetServiceServer interface {
	...
	// server streaming api
	GreetedManyTimes(*GreetManyTimesRequest, GreetService_GreetedManyTimesServer) error
	// client streaming api
...
func (*UnimplementedGreetServiceServer) GreetedManyTimes(*GreetManyTimesRequest, GreetService_GreetedManyTimesServer) error {
	return status.Errorf(codes.Unimplemented, "method GreetedManyTimes not implemented")
}
...
func _GreetService_GreetedManyTimes_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GreetManyTimesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GreetServiceServer).GreetedManyTimes(m, &greetServiceGreetedManyTimesServer{stream})
}

type GreetService_GreetedManyTimesServer interface {
	Send(*GreetManyTimesResponse) error
	grpc.ServerStream
}

type greetServiceGreetedManyTimesServer struct {
	grpc.ServerStream
}

func (x *greetServiceGreetedManyTimesServer) Send(m *GreetManyTimesResponse) error {
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GreetedManyTimes",
			Handler:       _GreetService_GreetedManyTimes_Handler,
			ServerStreams: true,
		},
		{
